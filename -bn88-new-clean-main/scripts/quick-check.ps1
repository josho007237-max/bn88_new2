...
if (-not $listen3000) {
  Fail 'BACKEND' 'Backend not running' 'Run: cd bn88-backend-v12; npm ci; npx prisma generate; npx prisma db push; npm run dev (and check ENV SECRET_ENC_KEY_BN9 length=32)'
